...
export function DoctorForm() {
  ...
  async function onSubmit(values) {
    try {
      ...
      if (!doctorData) {
        await supabase.auth.signOut();
        throw new Error('No doctor profile found. Please register as a medical professional.');
      }
      ...
      <div className="space-y-8">
        ...
        <div className="text-center">
          <div className="flex flex-col items-center mb-6">
            <div className="relative mb-4">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full blur-lg opacity-30"></div>
              <div className="relative p-4 bg-gradient-to-br from-blue-600 to-emerald-600 rounded-2xl shadow-lg">
                <Stethoscope className="w-12 h-12 text-white" />
              </div>
            </div>
            <h2 className="text-3xl font-bold text-gray-800 mb-2">
              Medical <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-600">Professional</span>
            </h2>
            <p className="text-gray-500">
              Access patient records and advanced medical tools
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mb-6 p-3 bg-blue-50 rounded-xl">
            ...
            <span className="text-sm font-medium text-blue-700">HIPAA Compliant • Medical Grade Security</span>
          </div>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/doctor-forgot-password" className="text-sm text-blue-600 hover:text-blue-800 font-medium">
              Forgot password?
            </Link>
          </div>
          ...
          {success && (
              <div className="p-4 bg-green-50 border-2 border-green-200 rounded-xl flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-green-700 font-medium">Authentication successful! Redirecting to dashboard...</p>
                </div>
              </div>
          )}
          ...
          <Button
              type="submit"
              disabled={loading}
              className="w-full group font-bold py-4 px-6 rounded-xl transition-all duration-300 bg-gradient-to-r from-blue-600 to-emerald-600 text-white hover:shadow-xl hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-sm text-gray-500">Or access as</span>
            </div>
          </div>
        ...
        {/* Quick Stats */}
        <div className="bg-gradient-to-br from-blue-50 to-emerald-50 rounded-xl p-4 mt-6">

...
const AdminPatientsPage = () => {
    ...
    const patients = [
        ...
        },
        {
            id: 5,
            name: "Karim Rashid",
            email: "karim.rashid@example.com",
            phone: "+213 598 765 432",
            dob: "05/09/1995",
            gender: "Male",
            bloodType: "O-",
    ...
    const stats = [
        { label: "Total Patients", value: patients.length, icon: <User className="w-5 h-5" />, color: "from-blue-500 to-cyan-500" },
        { label: "Active Patients", value: patients.filter(p => p.status === "Active").length, icon: <CheckCircle className="w-5 h-5" />, color: "from-green-500 to-emerald-500" },
        { label: "Inactive Patients", value: patients.filter(p => p.status === "Inactive").length, icon: <XCircle className="w-5 h-5" />, color: "from-red-500 to-pink-500" },
        { label: "Pending", value: patients.filter(p => p.status === "Pending").length, icon: <Clock className="w-5 h-5" />, color: "from-yellow-500 to-orange-500" }
    ];
                ...
                <div className="mb-8">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        <div>
                            ...
                            <p className="text-lg text-gray-600">Manage and monitor all registered patients</p>
                        </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-sm font-bold text-gray-700">Contact Info</th>
                            ...
                            {loading ? (
                                ...
                                patients.map((patient) => (
                                    <tr key={patient.id} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="space-y-1">
                                                <p className="text-sm font-medium text-gray-700">{patient.lastVisit}</p>
                                                <p className="text-xs text-gray-500">{patient.totalVisits} total visits</p>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                        <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-semibold border-2 ${getStatusBadge(patient.status)}`}>
                          {patient.status}
                        </span>
                                        </td>
                                        <td className="px-6 py-4">
                    ...
                    <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
                        <div className="flex items-center justify-between">
                            <p className="text-sm text-gray-600">
                                Showing <span className="font-semibold">1-{patients.length}</span> of <span className="font-semibold">{patients.length}</span> patients
                            </p>
                            <div className="flex gap-2">
